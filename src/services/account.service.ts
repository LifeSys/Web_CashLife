...
class AccountService {
  ...
  async create(
    ...
    return createAccountRecordAction(uid, account);
  }
  ...
  async ensureEfectivoExists(uid: string): Promise<Account> {
    ...
    return createAccountRecordAction(uid, {
      nombre: 'Efectivo',
      tipo: 'cash',
      banco: 'Efectivo',
      saldo: 0,
  ...
  async update(uid: string, id: string, data: Partial<Account>): Promise<Account | null> {
    ...
    return updateAccountRecordAction(uid, id, data);
  }
  ...
  async delete(uid: string, id: string): Promise<void> {
    ...
    return deleteAccountRecordAction(uid, id);
  }
