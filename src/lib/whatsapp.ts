...
export const DEFAULT_DEBT_TEMPLATE = 'Hola {cliente}, tenemos registrado que me debes {monto}. ¿Puedes agendar un pago?{metodoPago}';
 ...
 * intención de cobro.
 */
export function buildDebtMessage({ contactName, netBalance, paymentMethodLabel, paymentMethodValue, template }: BuildDebtMessageInput): string {
  if (netBalance > 0) {
