...
import { Zap, Eye, CreditCard as CardIcon, Edit2, Trash2, TrendingDown, Banknote, ShoppingCart } from 'lucide-react';
...
interface CreditCardDisplayProps {
  ...
  onEdit?: () => void;
  onDelete?: () => void;
  /** Fila angosta tipo lista en vez de la tarjeta visual grande. */
  compact?: boolean;
}
